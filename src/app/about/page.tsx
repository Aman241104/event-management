...
const TransitionMoment = ({ text }: { text: string }) => (
  <div className="py-12 flex justify-center opacity-0 translate-y-4 transition-all duration-1000 scroll-reveal">
...
export default function AboutPage() {
  ...
  useGSAP(() => {
    if (prefersReducedMotion) {
      gsap.set("section, .scroll-reveal, .philosophy-image-container, .philosophy-text-block > div, .difference-item, .values-divider, .process-step, .cta-content-reveal", { 
        opacity: 1, 
        y: 0, 
        scale: 1,
        scaleY: 1
    ...
    heroTl.to(".hero-header-reveal", { opacity: 1, y: 0, duration: 1, ease: DEFAULT_EASE })
          .to(".hero-header-line", { height: 40, duration: 1, ease: "power2.inOut" }, "-=0.8")
          ...
          .to(".hero-subtext", { opacity: 1, y: 0, duration: 1, ease: DEFAULT_EASE }, "-=0.8")
          .to(".hero-signals", { opacity: 1, duration: 1 }, "-=0.5")
          .to(".hero-scroll-cue", { opacity: 1, y: 0, duration: 1, ease: "power2.out" }, "-=0.6");
  ...
  return (
    <main ref={mainRef} className="min-h-screen bg-canvas selection:bg-burnished selection:text-canvas relative overflow-hidden transition-colors duration-1000 pb-16">
      <div ref={containerRef} className="relative">
        ...
        {/* 1. Hero Section */}
        <section id="hero" className="relative min-h-[95vh] flex items-center justify-center overflow-hidden opacity-0" data-bg="var(--color-canvas)">
          <div className="absolute inset-0 bg-black/65 z-10 pointer-events-none" />
          <div className="absolute inset-0 bg-gradient-to-br from-black/80 via-black/30 to-black/70 z-10 pointer-events-none" />
          <div className="absolute inset-0 z-10 pointer-events-none" style={{ backgroundColor: 'rgba(180,140,90,0.05)' }} />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.3),transparent_80%)] z-10 pointer-events-none" />
          ...
          <div className="absolute inset-0 z-0 hero-bg-wrapper will-change-transform">
            <ParallaxImage 
              src="/hero-9.jpg" 
              alt="Luxury ballroom setup with gold accents and warm lighting" 
              speed={0.1}
              className="scale-105"
          ...
          <div className="container max-w-7xl relative z-20 text-center flex flex-col items-center">
            <div className="relative">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="hero-header-reveal flex flex-col items-center gap-4 mb-12 opacity-0 translate-y-8">
                  <span className="text-[10px] font-mono text-white/50 uppercase tracking-[0.5em] small-caps">01 / OUR STORY</span>
                  <div className="hero-header-line h-0 w-[1px] bg-gradient-to-b from-burnished/60 to-transparent" />
                </div>
                ...
                <p className="hero-subtext text-lg md:text-xl text-white/80 max-w-[520px] leading-relaxed font-sans font-light mt-12 drop-shadow-md opacity-0 translate-y-8">
                ...
                <div className="hero-signals mt-8 opacity-0 flex items-center justify-center gap-6">
                  <span className="text-[10px] tracking-[0.3em] uppercase text-white/40 font-mono">150+ Curated Events</span>
                  <div className="w-1 h-1 rounded-full bg-burnished/40" aria-hidden="true" />
                  <span className="text-[10px] tracking-[0.3em] uppercase text-white/40 font-mono">Serving Globally</span>
                </div>

                <div className="hero-scroll-cue mt-16 opacity-0 translate-y-4">
        ...
        <section className="py-6 border-y border-linen/60 bg-white/50 backdrop-blur-sm opacity-0" data-bg="var(--color-canvas)" aria-label="Brand partners and publications">
          <InfiniteMarquee 
        ...
        <section id="philosophy" className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-b from-white to-[#f8f6f2] opacity-0" data-bg="var(--color-canvas)">
          <div className="container max-w-7xl relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-start">
              <div className="lg:col-span-5 order-1 lg:order-2 philosophy-text-block space-y-10">
                <div className="space-y-6">
                  <h2 className="text-4xl md:text-6xl lg:text-7xl font-serif text-text-primary font-medium leading-[1.05] tracking-tight">
                    <span className="block overflow-hidden">
                ...
                <div className="space-y-8 text-lg md:text-xl text-text-secondary/80 font-sans font-light leading-relaxed max-w-md">
                  <p className="opacity-0 translate-y-8 philosophy-fade">
                  ...
                  <blockquote className="opacity-0 translate-y-8 philosophy-fade italic text-text-secondary/60 text-base border-l-2 border-burnished/20 pl-4">
                    "An experience that felt effortless from start to finish."
                  </blockquote>
                </div>

                <div className="space-y-4 pt-4 opacity-0 translate-y-8 philosophy-fade">
                  {[
              ...
              <div className="lg:col-span-7 order-2 lg:order-1 philosophy-image-container relative group opacity-0 scale-95 transition-all duration-1000 will-change-transform">
                <div className="relative overflow-hidden rounded-xl h-[45vh] md:h-[80vh] w-full shadow-2xl z-10">
                  <Image 
                    src="/hero-9.jpg" 
                    alt="Elegant indoor event space with grand chandeliers and floral decor" 
                    fill 
        ...
        <section id="difference" className="relative py-24 md:py-32 overflow-hidden bg-white opacity-0" data-bg="var(--color-canvas)">
              ...
              <div className="lg:col-span-7 difference-items-container">
                <div className="flex flex-col">
                  {[
                    ...
                    <div key={item.id} className="difference-item group border-t border-linen py-10 flex justify-between items-start opacity-0 translate-y-12 transition-all duration-500">
        ...
        <section id="values" className="relative py-24 md:py-40 overflow-hidden opacity-0" data-bg="var(--color-heritage)">
          <div className="absolute inset-0 z-0">
            <Image 
              src="/hero-8.jpg" 
              alt="Intimate wedding reception with elegant tabletop settings" 
              fill 
          ...
          <div className="container max-w-7xl relative z-20">
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1px_1fr] gap-16 md:gap-24 max-w-6xl mx-auto items-center text-white">
              <div className="values-left space-y-8 transition-all duration-700 hover:brightness-110 group opacity-0 translate-y-12">
              ...
              <div className="hidden md:block w-px h-72 bg-white/10 values-divider opacity-0 scale-y-0 origin-center transition-all duration-1000 group-hover:bg-white/30" aria-hidden="true" />

              <div className="values-right space-y-8 transition-all duration-700 hover:brightness-110 group opacity-0 translate-y-12">
                <div className="space-y-4">
        ...
        <section id="process" className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-b from-white to-[#f5f2ec] opacity-0" data-bg="var(--color-canvas)">
          ...
          <div className="container max-w-7xl relative z-10">
            <div className="process-header max-w-2xl mb-24 opacity-0 translate-y-12">
            ...
            <div className="process-steps-container relative lg:ml-40">
              ...
              <div className="flex flex-col">
                {[
                  ...
                  <div key={step.id} className="process-step group relative pl-12 md:pl-24 py-12 md:py-16 opacity-0 translate-y-12 last:pb-0">
        ...
        {/* 6. Final CTA Section */}
        <section id="cta" className="relative min-h-[95vh] flex items-center justify-center overflow-hidden border-t border-white/5 opacity-0" data-bg="var(--color-heritage)">
          <div className="absolute inset-0 z-0">
             <Image 
              src="/hero10.jpg" 
              alt="Celebration moment with joy and elegance" 
              fill 
             ...
             <div className="absolute inset-0 opacity-20 z-30" style={{ backgroundColor: 'rgba(180,140,90,0.06)' }} aria-hidden="true" />
          </div>
            ...
            <div className="cta-content-reveal max-w-3xl w-full flex flex-col items-center space-y-16">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-4 w-full">
                <Magnetic strength={0.08}>
                  <Link href="/contact" className="w-full md:w-auto" aria-label="Book a consultation with Zing Bliss">
                    <Button 
                ...
                <Magnetic strength={0.08}>
                  <Link href="/gallery" className="w-full md:w-auto" aria-label="View our portfolio of curated events">
                    <Button 
                      variant="outline"
