...
export function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-8 right-8 z-[60] flex flex-col items-center gap-4">
      {/* Tooltip-style label */}
      <div className="bg-white/90 backdrop-blur-md px-4 py-2 border border-linen/30 shadow-xl opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 pointer-events-none mb-2">
      ...
      <Magnetic strength={0.3}>
        <a
          ...
          className={cn(
            "group relative w-16 h-16 flex items-center justify-center bg-[#25D366] text-white rounded-full shadow-[0_20px_40px_rgba(37,211,102,0.3)] transition-all duration-500 hover:scale-110 active:scale-95",
            "after:absolute after:inset-0 after:rounded-full after:bg-[#25D366] after:animate-ping after:opacity-20 after:z-[-1]"
          )}
          aria-label="Chat on WhatsApp"
        >
          <WhatsAppLogo size={32} fill="white" className="relative z-10" />
